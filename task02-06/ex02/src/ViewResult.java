...
public abstract class ViewResult implements View {
     ...
     */
    @Override
    public void viewSave(String filename) throws IOException {
    ...
    /** Реализация метода {@linkplain View#viewRestore(String)}<br>
     * {@inheritDoc}
     */
    @SuppressWarnings("unchecked")
    @Override
    public void viewRestore(String fileName) throws Exception {
